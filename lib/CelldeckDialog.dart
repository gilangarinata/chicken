...
class CelldeckDialog extends StatefulWidget {
  CellDeck data;
  int lantai;

  CelldeckDialog({this.data, this.lantai});

  @override
  _AddDeviceDialogState createState() => _AddDeviceDialogState();
}

class _AddDeviceDialogState extends State<CelldeckDialog> {
  @override
  Widget build(BuildContext context) {
    return DialogContent(widget.data, widget.lantai);
  }
}
...
class DialogContent extends StatefulWidget {
  ...
  DialogContent(this.data, this.lantai);
